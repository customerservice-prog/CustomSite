 ...
 * Cloud save: the API auto-creates a `projects` row on first `site_files` write when missing
 * (`routes/siteBuilder.js` — same for any UUID, not only this id). Optional: run `supabase/seed-demo-builder-project.sql`.
 */
